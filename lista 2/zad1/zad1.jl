...
for x in type
    ...
    v3 = x[2.718281828, -3.141592654, 1.414213562, 0.577215664, 0.301029995]

    println("\n", x, "\npo modyfikacja wektora\n")
    println("wynik")
    a = forwardMultip(v3, v2, x)
    println("a: ", a)
   
    b = backwardMultip(v3, v2, x)
    println("b: ", b)

    c = sortedMultip(v3, v2, x, true)
    println("c: ", c)

    d = sortedMultip(v3, v2, x, false)
    println("d: ", d)
